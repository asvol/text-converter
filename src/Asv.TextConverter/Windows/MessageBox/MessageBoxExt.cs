...
namespace Asv.TextConverter
{
    ...
    {
        public static object ShowMessageBox(this IWindowManager src, string caption, string message, MessageBoxIconType icon, MessageBoxHelpButton helpButton, params MessageBoxButtonExt[] buttons)
        {
            object result = null;
        ...
        {
            var result = src.ShowMessageBox(caption, message, icon, helpButton, buttons.Cast<MessageBoxButtonExt>().ToArray());
        ...
        {
            src.ShowMessageBox(caption, message, MessageBoxIconType.Error, helpButton, new MessageBoxButtonExt(MessageBoxRS.CaliburnDialogs_ShowError_Ok, null, true, true));
        }

        public static void ShowError(this IWindowManager src, string caption, string message, Exception ex)
        {
            src.ShowMessageBox(caption, message, MessageBoxIconType.Error, new MessageBoxHelpButton(MessageBoxRS.CaliburnDialogs_ShowError_More, () => src.ShowExceptionInfoDialog(MessageBoxRS.CaliburnDialogs_ShowError_More, ex)), new MessageBoxButtonExt(MessageBoxRS.CaliburnDialogs_ShowError_Ok, null, true, true));
        }

        public static void ShowInfo(this IWindowManager src, string caption, string message, MessageBoxHelpButton helpButton = null)
        {
            src.ShowMessageBox(caption, message, MessageBoxIconType.Info, helpButton, new MessageBoxButtonExt(MessageBoxRS.CaliburnDialogs_ShowError_Ok, null, true, true));
        }
        ...
        {
            src.ShowMessageBox(caption, message, MessageBoxIconType.Warning, helpButton, new MessageBoxButtonExt(MessageBoxRS.CaliburnDialogs_ShowError_Ok, null, true, true));
        }
